                            ...
                            <div class="row">
                                <div class="col-lg-8 col-sm-12">
                                    <div class="slider-content second-slider-content">
										...
										<div class="conterdown wow fadeInDown animated" data-animation="fadeInDown animated" data-delay=".2s" countdown data-date="Jan 1 2022 00:00:00">
										 <div class="timer">										 
                ...
                <div class="container">
                    <div class="row align-items-center">                       
                        <div class="col-lg-6">
						 ...
						 <div class="col-lg-6">
                         <div class="s-video-wrap" style="background-image:url(img/video_bg_2.jpg)">
